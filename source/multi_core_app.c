...
/*!
 * @brief FREERTOS task: "Comm task"
 *
 * This task handles communication between M4 and M7 cores.
 * sends imu, lightranger  sensors data from m4 to m7.
 */
...
//        &xPrimaryToSecondaryMessageBufferStruct);
      xPrimaryToSecondaryMessageBuffer = xMessageBufferCreate(APP_MESSAGE_BUFFER_SIZE);
